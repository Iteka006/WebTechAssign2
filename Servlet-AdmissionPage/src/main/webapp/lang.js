...
const translations = {
    ...
    local: {
        loginTitle: "Login in Local Language",
        enterDetailsText: "Please enter your local details",
        idPlaceholder: "Enter your local ID",
        passwordPlaceholder: "Enter your local Password",
        loginButtonText: "Login in Local Language",
        noAccountText: "No Account? Register",
        forgotPasswordText: "Forgot Password?",
    },
};
